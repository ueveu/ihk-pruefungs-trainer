    ...
    <div className="animate-fade-in">
      ...
      <div className="relative">
        <button 
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 -ml-4 md:ml-0 bg-white rounded-full p-2 shadow-md z-10"
        >
        ...
        <button 
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 -mr-4 md:mr-0 bg-white rounded-full p-2 shadow-md z-10"
        >
      ...
      <div className="mt-6 flex justify-center gap-4">
        <button 
          ...
          className="px-6 py-3 bg-error text-white rounded-lg hover:bg-error/90 transition-colors flex items-center gap-2"
        >
          <X className="h-5 w-5" />
          Nicht gewusst
        </button>
        <button 
          ...
          className="px-6 py-3 bg-success text-white rounded-lg hover:bg-success/90 transition-colors flex items-center gap-2"
        >
